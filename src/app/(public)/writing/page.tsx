...
const FEATURED = {
  ...
  excerpt:
    "What I'd tell myself before building LedgerLoop's ledger a second time — where event sourcing earned its keep, where it added ceremony, and the three rules I'd keep.",
  slug: '#',
};
...
const POSTS = [
  {
    ...
    excerpt:
      'Coordination, backpressure, and eventual consistency — but with dinosaurs and a Discord server.',
    category: 'community',
    readTime: '6 min',
  },
  {
    ...
    excerpt:
      "Retries, idempotency, and observability aren't the fun part. They're most of the value.",
    category: 'engineering',
    readTime: '5 min',
  },
  {
    ...
    excerpt:
      'A five-dimensional scoring model for a joke quiz. The joke got funnier the more correct it got.',
  ...
  },
  {
    ...
    excerpt:
      "A short, opinionated list. Fewer rules than you'd think, held more strictly than you'd like.",
    category: 'engineering',
    readTime: '9 min',
  },
];
